...
<body>
  <nav class="navbar navbar-expand-lg fixed-top">
    ...
    <a class="navbar-brand" href="#"><img src="{{ asset('panel/img/logo.png') }}" height="64" style="margin-right: 0.9em;" /></a>
        ...
        <div class="sideMenu bg-mattBlackLight" style="font-size: 18px;">
            <div class="sidebar">
                ...
                <ul class="navbar-nav">
                  ...
                  <li class="nav-item"><a href="{{ route('the_dashboard') }}" class="nav-link px-2"><i class="material-icons icon">dashboard</i><span class="text">لوحة التحكم </span></a></li>

                  <li class="nav-item"><a href="{{ route('categories.index') }}" class="nav-link px-2"><i class="material-icons icon">category</i><span class="text">التصنيفات</span></a></li>

                  <li class="nav-item"><a href="{{ route('posts.index') }}" class="nav-link px-2"><i class="material-icons icon">email</i><span class="text">المقالات</span></a></li>

                  <li class="nav-item"><a href="{{ route('users.index') }}" class="nav-link px-2"><i class="material-icons icon">person</i><span class="text"> المستخدمين </span></a></li>
